...
//---
{
  final class A[T] private (private[this] val _i: Int, private[this] val _b: Boolean, private[this] val _t: T) {
    ...
    override def hashCode: _root_.scala.Int = i.hashCode + 13 * (b.hashCode + 13 * t.hashCode)
    override def toString: _root_.java.lang.String = "A(" + (i.toString + "," + b.toString + "," + t.toString) + ")"
