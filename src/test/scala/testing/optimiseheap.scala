...
final object Foo extends ((Option[Boolean], Option[Boolean], Option[String]) => Foo) with Serializable {
  ...
  private def pack(a: Option[Boolean], b: Option[Boolean], s: Option[String]): (Long, Array[Byte]) = {
  ...
  def unapply(f: Foo): Option[(Option[Boolean], Option[Boolean], Option[String])] = Some((f.a, f.b, f.s))
  ...
  implicit val TypeableFoo: Typeable[Foo] = new Typeable[Foo] {
    ...
    override def describe: String = s"Foo[Option[Boolean],Option[Boolean],Option[String]]"
  }

  implicit val LabelledGenericFoo: LabelledGeneric.Aux[Foo, FieldType[a_tpe.type, Option[Boolean]] :: FieldType[b_tpe.type, Option[Boolean]] :: FieldType[s_tpe.type, Option[String]] :: HNil] =
  ...
  implicit val GenericFoo: Generic.Aux[Foo, Option[Boolean] :: Option[Boolean] :: Option[String] :: HNil] =
    new Generic[Foo] {
